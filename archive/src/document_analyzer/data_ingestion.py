...
if __name__ == "__main__":
    ...
    #pdf_path=r"C:\\siddhesh\\document_portal\\data\document_analysis\\NIPS-2017-attention-is-all-you-need-Paper.pdf"
    pdf_path=r"C:\\siddhesh\\document_portal\\data\document_analysis\\sample.pdf"
    class DummnyFile:
